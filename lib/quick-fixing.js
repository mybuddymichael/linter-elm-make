...
export default {
  // TODO: Tests.
  getFixesForProblem(problem, rangeText, editorFilePath) {
    if (problem.tag) {
      return getFixesForTaggedProblem(problem, rangeText);
    }
    let matches = null;
...
function getFixesForTaggedProblem(problem, rangeText) {
  let matches = null;
  switch (problem.tag) {
    case 'NAMING ERROR':
