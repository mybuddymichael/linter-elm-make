...
module.exports = {
  ...
  activate() {
    ...
    this.quickFixView.onDidConfirm(({editor, range, fix}) => {
      ...
      self.clearElmEditorFixes(editor);
      self.clearElmEditorProblems(editor);
    });
  ...
  quickFixAll() {
    ...
    if (quickFixes) {
      ...
      this.clearElmEditorFixes(editor);
      this.clearElmEditorProblems(editor);
    }
  },
