...
function doLint(filePath, inputFilePath, textEditor) {
  ...
  .then(data => {
    return new Promise((resolve, reject) => {
      if (data.stderr === '') {
        parseStdout(data.stdout, filePath, inputFilePath, projectRootDirectory, textEditor, progressIndicator, resolve);
      } else {
...
function parseStdout(stdout, filePath, inputFilePath, projectRootDirectory, textEditor, progressIndicator, resolve) {
