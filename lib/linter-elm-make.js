...
export default {
  ...
  activate() {
    ...
    if (!atom.packages.isPackageLoaded('linter') && !atom.packages.isPackageLoaded('nuclide')) {
      atom.notifications.addError("The `linter` (or `nuclide`) package was not loaded", {
        detail: 'Please install or enable the `linter` (or `nuclide`) package in your Settings view.',
        dismissable: true
      });
    }
