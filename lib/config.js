...
export default {
  ...
  lintOnTheFly: {
    ...
    description: 'Lint files while typing, without the need to save.  Be sure to check the `Lint on Change` (`Lint As You Type` for Linter v1) option in the Linter package settings for this to work.',
    type: 'boolean',
    default: false,
    order: 2
  },
  ...
  showCodeActions: {
    title: 'Show Quick Fixes As Code Actions',
